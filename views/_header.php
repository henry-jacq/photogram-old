	...
	<nav class="navbar navbar-expand-lg px-3 border-bottom shadow shadow-bottom">
		...
		<ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
			...
			<li class="nav-item dropdown ms-2">
				...
				<div class="dropdown-menu dropdown-animation dropdown-menu-end dropdown-menu-size-md p-0 shadow-lg border-0 mt-2"
							...
							<ul class="list-group list-group-flush list-unstyled p-2">
								...
								<li>
									<div
										...
										<div class="avatar text-center d-none d-sm-inline-block">
											<img class="avatar-img rounded-circle" src="/assets/random_images/cj.jpg"
												alt="CJ" width="28" height="30">
										</div>
										<div class="ms-sm-3">
											<div class=" d-flex">
									...
									<div
										...
										<div class="avatar text-center d-none d-sm-inline-block">
											<img class="avatar-img rounded-circle"
												src="/assets/random_images/kratos.jpg" alt="kratos" width="28"
												height="30">
										</div>
										<div class="ms-sm-3">
											<div class=" d-flex">
								...
								<li>
									<a href="#"
										...
										<div class="avatar text-center d-none d-sm-inline-block">
											<img class="avatar-img p-1" src="/assets/brand/photogram-logo.png" alt=""
												width="30" height="34">
										</div>
			...
			<li class="nav-item ms-3 dropdown">
				...
				<ul class="dropdown-menu dropdown-animation dropdown-menu-end pt-2 small mt-2"
					...
					<li><a class="dropdown-item bg-danger-soft-hover" href="/logout"><i
								class="bi bi-box-arrow-left fa-fw me-2"></i>Sign Out</a></li>
				</ul>
			</li>
			<!-- Profile START -->
		</ul>
