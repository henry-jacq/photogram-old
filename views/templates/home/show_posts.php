...
if (Session::currentScript() == 'index') { ?>
	<div class="d-flex justify-content-between align-items-center">
		...
		<div class="btn-group btn-group-sm" role="group" aria-label="Basic radio toggle button group">
			...
			<label class="btn btn-outline-secondary rounded-start-4" for="btnradio1"><i class="bi bi-grid-3x3 me-2"></i>Mosaic</label>

			<input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
			<label class="btn btn-outline-secondary rounded-end-4" for="btnradio2"><i class="bi bi-grid-1x2 me-2"></i>Stream</label>
		</div>
	</div>
...
<div class="row g-3" id="masonry-area">
	...
	<?php foreach ($posts as $post) {
		...
		<div class="col-lg-4 col-md-6 col-sm-12" id="post-<?= $post['id'] ?>">
				...
				<?php if (Session::isAuthenticated()) { ?>
					<header class="card-header p-2 user-select-none border-0">
						<div class="d-flex align-items-center justify-content-between">
							...
							<div class="dropdown">
								<a href="#" class="text-secondary btn btn-secondary-soft-hover py-1 px-2 rounded-circle" id="postCardFeedAction" data-bs-toggle="dropdown" aria-expanded="false">
