				...
				<div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
					<div class="card">
						<div class="card-body">
							...
							<hr>
							<h6><i class="fa fa-user me-2"></i>Change Username</h6>
							...
							<form>
								<div class="form-group input-group">
									...
									<input type="text" class="form-control" id="username" aria-describedby="usernameHelp" placeholder="Your Username" value="<?= Session::getUser()->getUsername() ?>">
								</div>
								...
								<form>
									<div class="form-group">
										<h6 class="d-block"><i class="fa fa-shield-halved me-2"></i>Two Factor Authentication (2FA)</h6>
										...
										<div class="row">
											...
											<div class="col-lg-4 my-auto ms-auto">
												...
												<button class="btn btn-outline-primary" type="button"><i class="fas fa-shield-halved me-2"></i>Enable 2FA now!</button>
											</div>
										</div>
									</div>
								</form>
								<hr>
								<h6><i class="fa fa-trash me-2"></i>Delete account</h6>
								<div class="form-group">
									...
									<ul>
										...
										<li>Your <?php
													echo (Post::countUserPosts(Session::getUser()->getUsername())[0]['count']);
													?> posts will be removed and cannot be restored.</li>
								...
								<button class="btn btn-danger btn-sm" type="button" onclick="dialog('Delete account?',' Are you sure want to delete your account ?');" id="delete-account-button"><i class="fa fa-trash me-2"></i>Delete Account</button>
							</form>
						</div>
					</div>
				</div>
				<div class="tab-pane fade" id="emails" role="tabpanel" aria-labelledby="emails-tab">
					<div class="card">
						<div class="card-body">
							...
							<ul class="mt-2">
								<li><?= Session::getUser()->getEmail() ?> <div class="badge bg-primary rounded-pill">Primary</div>
								</li>
							</ul>
							<form>
								<div class="form-group mb-3">
								...
								<button class="btn btn-prime">Add email address</button>
							</form>
							<hr>
							<h5 class="fw-normal">Linked emails (1)</h5>
							<div class="p-0 bg-body-tertiary border rounded-3">
								<ul class="mt-3">
									<li>Your primary email is used for sending notifications </li>
									<li>Your primary email will be displayed on your public profile.</li>
									<li>Your primary email is used for avatar detection. You can change it in your <a href="/edit-profile">profile settings</a>.</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="card-body">
							...
							<form>
								...
								<div class="form-group mb-3">
									...
									<select class="form-select" aria-label="Default select example">
										<option selected><?= Session::getUser()->getEmail() ?></option>
									</select>
								</div>
								<div class="form-group">
