    ...
    <div class="container p-5">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="card my-3 rounded-3 text-bg-secondary">
                    <div class="card-body">
                        ...
                        <a class="text-decoration-none text-light" href="https://github.com/henry-jacq/">Check Out my Github Page</a>.<br><br>
                        <i class="text-black">#IoT #electronics #hacking</i>
                    </div>
                </div>
