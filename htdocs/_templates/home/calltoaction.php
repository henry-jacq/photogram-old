...
<section class="py-4 text-center">
    <div class="row py-lg-5 border-bottom ">
        <div class="col-lg-7 col-md-8 mx-auto">
            <h1 class="display-6">What's on your mind, <?= strtolower(Session::getUser()->getUsername()); ?>?</h1>
            ...
            <form class="my-3" action="/" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <textarea class="form-control" name="post_text" placeholder="Say something..." id="captionArea" style="height: 160px;"></textarea>
